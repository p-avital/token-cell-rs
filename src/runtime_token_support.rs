    ...
    ($vis: vis $id: ident: $ty: ty) => {
        $crate::paste! {
            ...
            mod [<__ $id _mod__ >] {
                ...
                /// A token that's also checked at runtime, ensuring that a [`TokenCell`] is never accidentally used with another instance of the same token type.
                pub struct $id($ty);
